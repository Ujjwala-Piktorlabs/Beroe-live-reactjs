                    ...
                    <div className="inner-container">
                        ...
                        <div className="card-footer">
                            <div className="align-icons">
                                ...
                                <div className="vl"></div>
                                {this.props.INDEX !== 0 && <img className="down-size" src={download} alt="download-icon" />}
                            </div>
                            <div className="align-more">
                                <a href='#' className="change-link-text" id={this.props.BLOG.id} onClick={this.morelessToggleClass}>More</a>
